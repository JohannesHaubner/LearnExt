...
class LearnExtension(extension.ExtensionOperator):
    def __init__(self, mesh):
        ...
        output_directory = str("../Output/files/learned_step2/")
        self.net = ANN(output_directory + "neural_network_step2.pkl")
...
# save options
FSI_param['save_directory'] = str('./../Output/FSIbenchmarkII_learn_step2_adaptive') #no save if set to None
