...
class Problem:
    ...
    def load_mesh(self) -> Mesh:
        ...
        # with df.XDMFFile(str(self.mesh_path / "solid2.xdmf")) as outfile:
        #     # outfile.write(solid_mesh)
        #     outfile.write(solid_boundaries)
        ...
        # with df.XDMFFile(str(self.mesh_path / "fluid2.xdmf")) as outfile:
        #     # outfile.write(fluid_mesh)
        #     outfile.write(fluid_boundaries)
